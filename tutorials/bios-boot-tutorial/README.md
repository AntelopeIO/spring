...
3. Compile the latest [System Contracts](https://github.com/eosnetworkfoundation/system-contracts/releases). Replaces `release/*latest*` with the latest release branch.
