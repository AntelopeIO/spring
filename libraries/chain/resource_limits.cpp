...
void resource_limits_manager::add_to_snapshot( const snapshot_writer_ptr& snapshot, chainbase::database& db ) {
   resource_index_set::walk_indices([&snapshot, &db]( auto utils ){
