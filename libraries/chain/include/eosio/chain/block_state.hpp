...
FC_REFLECT( eosio::chain::finality_data_t, (major_version)(minor_version)(active_finalizer_policy_generation)(final_on_strong_qc_block_num)(sunset_finalizer_policy_digest)(action_mroot)(base_digest)(proposed_finalizer_policy) )
