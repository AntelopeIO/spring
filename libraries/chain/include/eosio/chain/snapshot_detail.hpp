...
namespace eosio::chain::snapshot_detail {
   ...
   struct snapshot_block_state_v7 {
      ...
      std::optional<std::pair<block_timestamp_type, proposer_policy_ptr>> latest_proposed_proposer_policy;
      std::optional<std::pair<block_timestamp_type, proposer_policy_ptr>> latest_pending_proposer_policy;
