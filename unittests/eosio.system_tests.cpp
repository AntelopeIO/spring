...
BOOST_FIXTURE_TEST_CASE( buysell, eosio_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( core_from_string("0.0000"), get_balance( "alice1111111"_n ) );

   transfer( "eosio"_n, "alice1111111"_n, core_from_string("1000.0000"), "eosio"_n );
   BOOST_REQUIRE_EQUAL( success(), stake( "eosio"_n, "alice1111111"_n, core_from_string("200.0000"), core_from_string("100.0000") ) );

   auto total = get_total_stake( "alice1111111"_n );
   ...
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111"_n, "alice1111111"_n, core_from_string("200.0000") ) );
   BOOST_REQUIRE_EQUAL( core_from_string("800.0000"), get_balance( "alice1111111"_n ) );
   BOOST_REQUIRE_EQUAL( initial_ram_balance + core_from_string("199.0000"), get_balance("eosio.ram"_n) );
   BOOST_REQUIRE_EQUAL( initial_ramfee_balance + core_from_string("1.0000"), get_balance("eosio.ramfee"_n) );

   total = get_total_stake( "alice1111111"_n );
   ...
   BOOST_REQUIRE_EQUAL( success(), sellram( "alice1111111"_n, bought_bytes ) );
   BOOST_REQUIRE_EQUAL( core_from_string("998.0049"), get_balance( "alice1111111"_n ) );
   total = get_total_stake( "alice1111111"_n );
   BOOST_REQUIRE_EQUAL( true, total["ram_bytes"].as_uint64() == init_bytes );

   transfer( "eosio"_n, "alice1111111"_n, core_from_string("100000000.0000"), "eosio"_n );
   BOOST_REQUIRE_EQUAL( core_from_string("100000998.0049"), get_balance( "alice1111111"_n ) );
   ...
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111"_n, "alice1111111"_n, core_from_string("10000000.0000") ) );
   BOOST_REQUIRE_EQUAL( core_from_string("90000998.0049"), get_balance( "alice1111111"_n ) );
   ...
   BOOST_REQUIRE_EQUAL( true, total["ram_bytes"].as_uint64() == init_bytes );
   BOOST_REQUIRE_EQUAL( core_from_string("99901248.0048"), get_balance( "alice1111111"_n ) );

   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111"_n, "alice1111111"_n, core_from_string("100.0000") ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111"_n, "alice1111111"_n, core_from_string("100.0000") ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111"_n, "alice1111111"_n, core_from_string("100.0000") ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111"_n, "alice1111111"_n, core_from_string("100.0000") ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111"_n, "alice1111111"_n, core_from_string("100.0000") ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111"_n, "alice1111111"_n, core_from_string("10.0000") ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111"_n, "alice1111111"_n, core_from_string("10.0000") ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111"_n, "alice1111111"_n, core_from_string("10.0000") ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111"_n, "alice1111111"_n, core_from_string("30.0000") ) );
   BOOST_REQUIRE_EQUAL( core_from_string("99900688.0048"), get_balance( "alice1111111"_n ) );

   auto newtotal = get_total_stake( "alice1111111"_n );
   ...
   BOOST_REQUIRE_EQUAL( success(), sellram( "alice1111111"_n, bought_bytes ) );
   BOOST_REQUIRE_EQUAL( core_from_string("99901242.4187"), get_balance( "alice1111111"_n ) );

   newtotal = get_total_stake( "alice1111111"_n );
   ...
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111"_n, "alice1111111"_n, core_from_string("100000.0000") ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111"_n, "alice1111111"_n, core_from_string("100000.0000") ) );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111"_n, "alice1111111"_n, core_from_string("300000.0000") ) );
   BOOST_REQUIRE_EQUAL( core_from_string("49301242.4187"), get_balance( "alice1111111"_n ) );

   auto finaltotal = get_total_stake( "alice1111111"_n );
   ...
   {
      transfer( config::system_account_name, "alice1111111"_n, core_from_string("10000000.0000"), config::system_account_name );
      uint64_t bytes0 = get_total_stake( "alice1111111"_n )["ram_bytes"].as_uint64();
      ...
      BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111"_n, "alice1111111"_n, payment ) );
      uint64_t bytes1 = get_total_stake( "alice1111111"_n )["ram_bytes"].as_uint64();
...
BOOST_FIXTURE_TEST_CASE( stake_unstake, eosio_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( core_from_string("1000.0000"), get_balance( "alice1111111"_n ) );
   BOOST_REQUIRE_EQUAL( success(), stake( "eosio"_n, "alice1111111"_n, core_from_string("200.0000"), core_from_string("100.0000") ) );
   ...
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111"_n, "alice1111111"_n, core_from_string("200.0000"), core_from_string("100.0000") ) );
   BOOST_REQUIRE_EQUAL( core_from_string("700.0000"), get_balance( "alice1111111"_n ) );
   BOOST_REQUIRE_EQUAL( init_eosio_stake_balance + core_from_string("300.0000"), get_balance( "eosio.stake"_n ) );
   BOOST_REQUIRE_EQUAL( success(), unstake( "alice1111111"_n, "alice1111111"_n, core_from_string("200.0000"), core_from_string("100.0000") ) );
   BOOST_REQUIRE_EQUAL( core_from_string("700.0000"), get_balance( "alice1111111"_n ) );
   ...
   BOOST_REQUIRE_EQUAL( wasm_assert_msg("refund is not available yet"),
                       push_action( "alice1111111"_n, "refund"_n, mvo()("owner", "alice1111111"_n) ) );

   // after 1 hour refund ready
   produce_block( fc::hours(1) );
   produce_blocks(1);
   // now we can do the refund
   BOOST_REQUIRE_EQUAL( success(), push_action( "alice1111111"_n, "refund"_n, mvo()("owner", "alice1111111"_n) ) );
   BOOST_REQUIRE_EQUAL( core_from_string("1000.0000"), get_balance( "alice1111111"_n ) );
   BOOST_REQUIRE_EQUAL( init_eosio_stake_balance, get_balance( "eosio.stake"_n ) );

   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111"_n, "bob111111111"_n, core_from_string("200.0000"), core_from_string("100.0000") ) );
   BOOST_REQUIRE_EQUAL( core_from_string("700.0000"), get_balance( "alice1111111"_n ) );
   total = get_total_stake("bob111111111"_n);
   BOOST_REQUIRE_EQUAL( core_from_string("210.0000"), total["net_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( core_from_string("110.0000"), total["cpu_weight"].as<asset>());
   ...
   REQUIRE_MATCHING_OBJECT( voter( "alice1111111"_n, core_from_string("300.0000")), get_voter_info( "alice1111111"_n ) );

   auto bytes = total["ram_bytes"].as_uint64();
   BOOST_REQUIRE_EQUAL( true, 0 < bytes );

   //unstake from bob111111111
   BOOST_REQUIRE_EQUAL( success(), unstake( "alice1111111"_n, "bob111111111"_n, core_from_string("200.0000"), core_from_string("100.0000") ) );
   total = get_total_stake("bob111111111"_n);
   ...
   REQUIRE_MATCHING_OBJECT( voter( "alice1111111"_n, core_from_string("0.0000") ), get_voter_info( "alice1111111"_n ) );
   produce_blocks(1);
   BOOST_REQUIRE_EQUAL( success(), push_action( "alice1111111"_n, "refund"_n, mvo()("owner", "alice1111111"_n) ) );
   BOOST_REQUIRE_EQUAL( core_from_string("1000.0000"), get_balance( "alice1111111"_n ) );
} FC_LOG_AND_RETHROW()
...
BOOST_FIXTURE_TEST_CASE( stake_unstake_with_transfer, eosio_system_tester ) try {
   ...
   transfer( "eosio"_n, "bob111111111"_n, core_from_string("1000.0000"), "eosio"_n );
   BOOST_REQUIRE_EQUAL( success(), stake_with_transfer( "bob111111111"_n, "alice1111111"_n, core_from_string("200.0000"), core_from_string("100.0000") ) );
   ...
   REQUIRE_MATCHING_OBJECT( voter( "alice1111111"_n, core_from_string("600.0000")), get_voter_info( "alice1111111"_n ) );

   //alice can unstake everything (including what was transferred)
   BOOST_REQUIRE_EQUAL( success(), unstake( "alice1111111"_n, "alice1111111"_n, core_from_string("400.0000"), core_from_string("200.0000") ) );
   BOOST_REQUIRE_EQUAL( core_from_string("700.0000"), get_balance( "alice1111111"_n ) );
   ...
   BOOST_REQUIRE_EQUAL( success(), push_action( "alice1111111"_n, "refund"_n, mvo()("owner", "alice1111111"_n) ) );
   BOOST_REQUIRE_EQUAL( core_from_string("1300.0000"), get_balance( "alice1111111"_n ) );
   ...
   BOOST_REQUIRE_EQUAL( success(), stake_with_transfer( "alice1111111"_n, "bob111111111"_n, core_from_string("100.0000"), core_from_string("100.0000") ) );
...
BOOST_FIXTURE_TEST_CASE( stake_to_self_with_transfer, eosio_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( wasm_assert_msg("cannot use transfer flag if delegating to self"),
                        stake_with_transfer( "alice1111111"_n, "alice1111111"_n, core_from_string("200.0000"), core_from_string("100.0000") )
   );
...
BOOST_FIXTURE_TEST_CASE( fail_without_auth, eosio_system_tester ) try {
   ...
   issue_and_transfer( "alice1111111"_n, core_from_string("1000.0000"),  config::system_account_name );

   BOOST_REQUIRE_EQUAL( success(), stake( "eosio"_n, "alice1111111"_n, core_from_string("2000.0000"), core_from_string("1000.0000") ) );
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111"_n, "bob111111111"_n, core_from_string("10.0000"), core_from_string("10.0000") ) );
   ...
   //REQUIRE_MATCHING_OBJECT( , get_voter_info( "alice1111111"_n ) );
} FC_LOG_AND_RETHROW()
...
BOOST_FIXTURE_TEST_CASE( stake_negative, eosio_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( wasm_assert_msg("must stake a positive amount"),
                        stake( "alice1111111"_n, core_from_string("-0.0001"), core_from_string("0.0000") )
   );

   BOOST_REQUIRE_EQUAL( wasm_assert_msg("must stake a positive amount"),
                        stake( "alice1111111"_n, core_from_string("0.0000"), core_from_string("-0.0001") )
   );

   BOOST_REQUIRE_EQUAL( wasm_assert_msg("must stake a positive amount"),
                        stake( "alice1111111"_n, core_from_string("00.0000"), core_from_string("00.0000") )
   );

   BOOST_REQUIRE_EQUAL( wasm_assert_msg("must stake a positive amount"),
                        stake( "alice1111111"_n, core_from_string("0.0000"), core_from_string("00.0000") )

   );

   BOOST_REQUIRE_EQUAL( true, get_voter_info( "alice1111111"_n ).is_null() );
} FC_LOG_AND_RETHROW()
...
BOOST_FIXTURE_TEST_CASE( unstake_negative, eosio_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111"_n, "bob111111111"_n, core_from_string("200.0001"), core_from_string("100.0001") ) );

   auto total = get_total_stake( "bob111111111"_n );
   BOOST_REQUIRE_EQUAL( core_from_string("210.0001"), total["net_weight"].as<asset>());
   auto vinfo = get_voter_info("alice1111111"_n );
   wdump((vinfo));
   REQUIRE_MATCHING_OBJECT( voter( "alice1111111"_n, core_from_string("300.0002") ), get_voter_info( "alice1111111"_n ) );


   BOOST_REQUIRE_EQUAL( wasm_assert_msg("must unstake a positive amount"),
                        unstake( "alice1111111"_n, "bob111111111"_n, core_from_string("-1.0000"), core_from_string("0.0000") )
   );

   BOOST_REQUIRE_EQUAL( wasm_assert_msg("must unstake a positive amount"),
                        unstake( "alice1111111"_n, "bob111111111"_n, core_from_string("0.0000"), core_from_string("-1.0000") )
   );

   //unstake all zeros
   BOOST_REQUIRE_EQUAL( wasm_assert_msg("must unstake a positive amount"),
                        unstake( "alice1111111"_n, "bob111111111"_n, core_from_string("0.0000"), core_from_string("0.0000") )
...
BOOST_FIXTURE_TEST_CASE( unstake_more_than_at_stake, eosio_system_tester ) try {
   ...
   issue_and_transfer( "alice1111111"_n, core_from_string("1000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111"_n, core_from_string("200.0000"), core_from_string("100.0000") ) );
   ...
   BOOST_REQUIRE_EQUAL( wasm_assert_msg("insufficient staked net bandwidth"),
                        unstake( "alice1111111"_n, core_from_string("200.0001"), core_from_string("0.0000") )
   );

   //trying to unstake more cpu bandwidth than at stake
   BOOST_REQUIRE_EQUAL( wasm_assert_msg("insufficient staked cpu bandwidth"),
                        unstake( "alice1111111"_n, core_from_string("0.0000"), core_from_string("100.0001") )
...
BOOST_FIXTURE_TEST_CASE( delegate_to_another_user, eosio_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( true, get_voter_info( "bob111111111"_n ).is_null() );

   //bob111111111 should not be able to unstake what was staked by alice1111111
   BOOST_REQUIRE_EQUAL( wasm_assert_msg("insufficient staked cpu bandwidth"),
                        unstake( "bob111111111"_n, core_from_string("0.0000"), core_from_string("10.0000") )

   );
   BOOST_REQUIRE_EQUAL( wasm_assert_msg("insufficient staked net bandwidth"),
                        unstake( "bob111111111"_n, core_from_string("10.0000"),  core_from_string("0.0000") )
   );

   issue_and_transfer( "carol1111111"_n, core_from_string("1000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "carol1111111"_n, "bob111111111"_n, core_from_string("20.0000"), core_from_string("10.0000") ) );
   total = get_total_stake( "bob111111111"_n );
   ...
   BOOST_REQUIRE_EQUAL( core_from_string("970.0000"), get_balance( "carol1111111"_n ) );
   REQUIRE_MATCHING_OBJECT( voter( "carol1111111"_n, core_from_string("30.0000") ), get_voter_info( "carol1111111"_n ) );

   //alice1111111 should not be able to unstake money staked by carol1111111

   BOOST_REQUIRE_EQUAL( wasm_assert_msg("insufficient staked net bandwidth"),
                        unstake( "alice1111111"_n, "bob111111111"_n, core_from_string("2001.0000"), core_from_string("1.0000") )
   );

   BOOST_REQUIRE_EQUAL( wasm_assert_msg("insufficient staked cpu bandwidth"),
                        unstake( "alice1111111"_n, "bob111111111"_n, core_from_string("1.0000"), core_from_string("101.0000") )
...
BOOST_FIXTURE_TEST_CASE( stake_unstake_separate, eosio_system_tester ) try {
   ...
   //everything at once
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111"_n, core_from_string("10.0000"), core_from_string("20.0000") ) );
   auto total = get_total_stake( "alice1111111"_n );
   ...
   //cpu
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111"_n, core_from_string("100.0000"), core_from_string("0.0000") ) );
   total = get_total_stake( "alice1111111"_n );
   BOOST_REQUIRE_EQUAL( core_from_string("120.0000"), total["net_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( core_from_string("30.0000"), total["cpu_weight"].as<asset>());

   //net
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111"_n, core_from_string("0.0000"), core_from_string("200.0000") ) );
   total = get_total_stake( "alice1111111"_n );
   BOOST_REQUIRE_EQUAL( core_from_string("120.0000"), total["net_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( core_from_string("230.0000"), total["cpu_weight"].as<asset>());

   //unstake cpu
   BOOST_REQUIRE_EQUAL( success(), unstake( "alice1111111"_n, core_from_string("100.0000"), core_from_string("0.0000") ) );
   total = get_total_stake( "alice1111111"_n );
   BOOST_REQUIRE_EQUAL( core_from_string("20.0000"), total["net_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( core_from_string("230.0000"), total["cpu_weight"].as<asset>());

   //unstake net
   BOOST_REQUIRE_EQUAL( success(), unstake( "alice1111111"_n, core_from_string("0.0000"), core_from_string("200.0000") ) );
   total = get_total_stake( "alice1111111"_n );
   BOOST_REQUIRE_EQUAL( core_from_string("20.0000"), total["net_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( core_from_string("30.0000"), total["cpu_weight"].as<asset>());
} FC_LOG_AND_RETHROW()
...
BOOST_FIXTURE_TEST_CASE( adding_stake_partial_unstake, eosio_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111"_n, "bob111111111"_n, core_from_string("100.0000"), core_from_string("50.0000") ) );
   ...
   REQUIRE_MATCHING_OBJECT( voter( "alice1111111"_n, core_from_string("450.0000") ), get_voter_info( "alice1111111"_n ) );
   BOOST_REQUIRE_EQUAL( core_from_string("550.0000"), get_balance( "alice1111111"_n ) );

   //unstake a share
   BOOST_REQUIRE_EQUAL( success(), unstake( "alice1111111"_n, "bob111111111"_n, core_from_string("150.0000"), core_from_string("75.0000") ) );
   ...
   REQUIRE_MATCHING_OBJECT( voter( "alice1111111"_n, core_from_string("225.0000") ), get_voter_info( "alice1111111"_n ) );

   //unstake more
   BOOST_REQUIRE_EQUAL( success(), unstake( "alice1111111"_n, "bob111111111"_n, core_from_string("50.0000"), core_from_string("25.0000") ) );
   total = get_total_stake( "bob111111111"_n );
   ...
   REQUIRE_MATCHING_OBJECT( voter( "alice1111111"_n, core_from_string("150.0000") ), get_voter_info( "alice1111111"_n ) );
   ...
   produce_blocks(1);
   BOOST_REQUIRE_EQUAL( success(), push_action( "alice1111111"_n, "refund"_n, mvo()("owner", "alice1111111"_n) ) );
   BOOST_REQUIRE_EQUAL( core_from_string("850.0000"), get_balance( "alice1111111"_n ) );
...
BOOST_FIXTURE_TEST_CASE( stake_from_refund, eosio_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111"_n, "bob111111111"_n, core_from_string("50.0000"), core_from_string("50.0000") ) );

   total = get_total_stake( "bob111111111"_n );
   BOOST_REQUIRE_EQUAL( core_from_string("60.0000"), total["net_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( core_from_string("60.0000"), total["cpu_weight"].as<asset>());

   REQUIRE_MATCHING_OBJECT( voter( "alice1111111"_n, core_from_string("400.0000") ), get_voter_info( "alice1111111"_n ) );
   BOOST_REQUIRE_EQUAL( core_from_string("600.0000"), get_balance( "alice1111111"_n ) );

   //unstake a share
   BOOST_REQUIRE_EQUAL( success(), unstake( "alice1111111"_n, "alice1111111"_n, core_from_string("100.0000"), core_from_string("50.0000") ) );
   total = get_total_stake( "alice1111111"_n );
   BOOST_REQUIRE_EQUAL( core_from_string("110.0000"), total["net_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( core_from_string("60.0000"), total["cpu_weight"].as<asset>());
   REQUIRE_MATCHING_OBJECT( voter( "alice1111111"_n, core_from_string("250.0000") ), get_voter_info( "alice1111111"_n ) );
   BOOST_REQUIRE_EQUAL( core_from_string("600.0000"), get_balance( "alice1111111"_n ) );
   ...
   BOOST_REQUIRE_EQUAL( core_from_string("110.0000"), total["net_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( core_from_string("60.0000"), total["cpu_weight"].as<asset>());
   REQUIRE_MATCHING_OBJECT( voter( "alice1111111"_n, core_from_string("350.0000") ), get_voter_info( "alice1111111"_n ) );
   BOOST_REQUIRE_EQUAL( core_from_string("500.0000"), get_balance( "alice1111111"_n ) );
   refund = get_refund_request( "alice1111111"_n );
   BOOST_REQUIRE_EQUAL( core_from_string("100.0000"), refund["net_amount"].as<asset>() );
   BOOST_REQUIRE_EQUAL( core_from_string( "50.0000"), refund["cpu_amount"].as<asset>() );

   //stake less than pending refund, entire amount should be taken from refund
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111"_n, "alice1111111"_n, core_from_string("50.0000"), core_from_string("25.0000") ) );
   total = get_total_stake( "alice1111111"_n );
   BOOST_REQUIRE_EQUAL( core_from_string("160.0000"), total["net_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( core_from_string("85.0000"), total["cpu_weight"].as<asset>());
   refund = get_refund_request( "alice1111111"_n );
   ...
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111"_n, "alice1111111"_n, core_from_string("300.0000"), core_from_string("200.0000") ) );
   total = get_total_stake( "alice1111111"_n );
   BOOST_REQUIRE_EQUAL( core_from_string("310.0000"), total["net_weight"].as<asset>());
   BOOST_REQUIRE_EQUAL( core_from_string("210.0000"), total["cpu_weight"].as<asset>());
   REQUIRE_MATCHING_OBJECT( voter( "alice1111111"_n, core_from_string("700.0000") ), get_voter_info( "alice1111111"_n ) );
   refund = get_refund_request( "alice1111111"_n );
   BOOST_TEST_REQUIRE( refund.is_null() );
   //200 core tokens should be taken from alice's account
   BOOST_REQUIRE_EQUAL( core_from_string("300.0000"), get_balance( "alice1111111"_n ) );
...
BOOST_FIXTURE_TEST_CASE( stake_to_another_user_not_from_refund, eosio_system_tester ) try {
   ...
   //unstake
   BOOST_REQUIRE_EQUAL( success(), unstake( "alice1111111"_n, core_from_string("200.0000"), core_from_string("100.0000") ) );
   auto refund = get_refund_request( "alice1111111"_n );
   BOOST_REQUIRE_EQUAL( core_from_string("200.0000"), refund["net_amount"].as<asset>() );
   BOOST_REQUIRE_EQUAL( core_from_string("100.0000"), refund["cpu_amount"].as<asset>() );
   ...
   BOOST_REQUIRE_EQUAL( core_from_string("400.0000"), get_balance( "alice1111111"_n ) );
   refund = get_refund_request( "alice1111111"_n );
   BOOST_REQUIRE_EQUAL( core_from_string("200.0000"), refund["net_amount"].as<asset>() );
   BOOST_REQUIRE_EQUAL( core_from_string("100.0000"), refund["cpu_amount"].as<asset>() );
...
BOOST_FIXTURE_TEST_CASE( producer_register_unregister, eosio_system_tester ) try {
   ...
   auto info = get_producer_info( "alice1111111"_n );
   ...
   info = get_producer_info( "alice1111111"_n );
   BOOST_REQUIRE_EQUAL( "alice1111111", info["owner"].as_string() );
...
BOOST_FIXTURE_TEST_CASE( vote_for_producer, eosio_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   ...
   auto prod = get_producer_info( "alice1111111"_n );
   ...
   issue_and_transfer( "bob111111111"_n, core_from_string("2000.0000"),  config::system_account_name );
   issue_and_transfer( "carol1111111"_n, core_from_string("3000.0000"),  config::system_account_name );

   //bob111111111 makes stake
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111"_n, core_from_string("11.0000"), core_from_string("0.1111") ) );
   BOOST_REQUIRE_EQUAL( core_from_string("1988.8889"), get_balance( "bob111111111"_n ) );
   REQUIRE_MATCHING_OBJECT( voter( "bob111111111"_n, core_from_string("11.1111") ), get_voter_info( "bob111111111"_n ) );
   ...
   prod = get_producer_info( "alice1111111"_n );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("11.1111")) == prod["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( "alice1111111", prod["owner"].as_string() );
   BOOST_REQUIRE_EQUAL( "http://block.one", prod["url"].as_string() );

   //carol1111111 makes stake
   BOOST_REQUIRE_EQUAL( success(), stake( "carol1111111"_n, core_from_string("22.0000"), core_from_string("0.2222") ) );
   REQUIRE_MATCHING_OBJECT( voter( "carol1111111"_n, core_from_string("22.2222") ), get_voter_info( "carol1111111"_n ) );
   BOOST_REQUIRE_EQUAL( core_from_string("2977.7778"), get_balance( "carol1111111"_n ) );
   ...
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111"_n, core_from_string("33.0000"), core_from_string("0.3333") ) );
   //alice1111111 stake with transfer to bob111111111
   BOOST_REQUIRE_EQUAL( success(), stake_with_transfer( "alice1111111"_n, "bob111111111"_n, core_from_string("22.0000"), core_from_string("0.2222") ) );
   ...
   BOOST_REQUIRE_EQUAL( success(), unstake( "carol1111111"_n, core_from_string("2.0000"), core_from_string("0.0002")/*"2.0000 EOS", "0.0002 EOS"*/ ) );
   ...
   BOOST_REQUIRE_EQUAL( core_from_string("1955.5556"), get_balance( "bob111111111"_n ) );

   //carol1111111 unstakes rest of eos
   BOOST_REQUIRE_EQUAL( success(), unstake( "carol1111111"_n, core_from_string("20.0000"), core_from_string("0.2220") ) );
   ...
   BOOST_REQUIRE_EQUAL( success(), push_action( "carol1111111"_n, "refund"_n, mvo()("owner", "carol1111111"_n) ) );
   BOOST_REQUIRE_EQUAL( core_from_string("3000.0000"), get_balance( "carol1111111"_n ) );
...
BOOST_FIXTURE_TEST_CASE( unregistered_producer_voting, eosio_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   issue_and_transfer( "bob111111111"_n, core_from_string("2000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111"_n, core_from_string("13.0000"), core_from_string("0.5791") ) );
   REQUIRE_MATCHING_OBJECT( voter( "bob111111111"_n, core_from_string("13.5791") ), get_voter_info( "bob111111111"_n ) );
...
BOOST_FIXTURE_TEST_CASE( vote_same_producer_30_times, eosio_system_tester ) try {
   issue_and_transfer( "bob111111111"_n, core_from_string("2000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111"_n, core_from_string("50.0000"), core_from_string("50.0000") ) );
   REQUIRE_MATCHING_OBJECT( voter( "bob111111111"_n, core_from_string("100.0000") ), get_voter_info( "bob111111111"_n ) );
...
BOOST_FIXTURE_TEST_CASE( vote_for_two_producers, eosio_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   ...
   issue_and_transfer( "carol1111111"_n, core_from_string("1000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "carol1111111"_n, core_from_string("15.0005"), core_from_string("5.0000") ) );
   BOOST_REQUIRE_EQUAL( success(), vote( "carol1111111"_n, { "alice1111111"_n, "bob111111111"_n } ) );

   auto alice_info = get_producer_info( "alice1111111"_n );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("20.0005")) == alice_info["total_votes"].as_double() );
   auto bob_info = get_producer_info( "bob111111111"_n );
   ...
   alice_info = get_producer_info( "alice1111111"_n );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("20.0005")) == alice_info["total_votes"].as_double() );
   bob_info = get_producer_info( "bob111111111"_n );
   BOOST_TEST_REQUIRE( 0 == bob_info["total_votes"].as_double() );

   //alice1111111 votes for herself and bob111111111
   issue_and_transfer( "alice1111111"_n, core_from_string("2.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111"_n, core_from_string("1.0000"), core_from_string("1.0000") ) );
...
BOOST_FIXTURE_TEST_CASE( proxy_register_unregister_keeps_stake, eosio_system_tester ) try {
   ...
   REQUIRE_MATCHING_OBJECT( proxy( "alice1111111"_n ), get_voter_info( "alice1111111"_n ) );
   ...
   REQUIRE_MATCHING_OBJECT( voter( "alice1111111"_n ), get_voter_info( "alice1111111"_n ) );

   //stake and then register as a proxy
   issue_and_transfer( "bob111111111"_n, core_from_string("1000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111"_n, core_from_string("200.0002"), core_from_string("100.0001") ) );
   BOOST_REQUIRE_EQUAL( success(), push_action( "bob111111111"_n, "regproxy"_n, mvo()
                                               ("proxy",  "bob111111111"_n)
                                               ("isproxy", true)
                        )
   );
   REQUIRE_MATCHING_OBJECT( proxy( "bob111111111"_n )( "staked", 3000003 ), get_voter_info( "bob111111111"_n ) );
   ...
   REQUIRE_MATCHING_OBJECT( voter( "bob111111111"_n, core_from_string("300.0003") ), get_voter_info( "bob111111111"_n ) );
   ...
   issue_and_transfer( "carol1111111"_n, core_from_string("1000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "carol1111111"_n, core_from_string("246.0002"), core_from_string("531.0001") ) );
   //check that both proxy flag and stake a correct
   REQUIRE_MATCHING_OBJECT( proxy( "carol1111111"_n )( "staked", 7770003 ), get_voter_info( "carol1111111"_n ) );
   ...
   REQUIRE_MATCHING_OBJECT( voter( "carol1111111"_n, core_from_string("777.0003") ), get_voter_info( "carol1111111"_n ) );
...
BOOST_FIXTURE_TEST_CASE( proxy_stake_unstake_keeps_proxy_flag, eosio_system_tester ) try {
   ...
   //stake
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111"_n, core_from_string("100.0000"), core_from_string("50.0000") ) );
   //check that account is still a proxy
   REQUIRE_MATCHING_OBJECT( proxy( "alice1111111"_n )( "staked", 1500000 ), get_voter_info( "alice1111111"_n ) );

   //stake more
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111"_n, core_from_string("30.0000"), core_from_string("20.0000") ) );
   //check that account is still a proxy
   REQUIRE_MATCHING_OBJECT( proxy( "alice1111111"_n )("staked", 2000000 ), get_voter_info( "alice1111111"_n ) );

   //unstake more
   BOOST_REQUIRE_EQUAL( success(), unstake( "alice1111111"_n, core_from_string("65.0000"), core_from_string("35.0000") ) );
   REQUIRE_MATCHING_OBJECT( proxy( "alice1111111"_n )("staked", 1000000 ), get_voter_info( "alice1111111"_n ) );

   //unstake the rest
   BOOST_REQUIRE_EQUAL( success(), unstake( "alice1111111"_n, core_from_string("65.0000"), core_from_string("35.0000") ) );
   REQUIRE_MATCHING_OBJECT( proxy( "alice1111111"_n )( "staked", 0 ), get_voter_info( "alice1111111"_n ) );
...
BOOST_FIXTURE_TEST_CASE( proxy_actions_affect_producers, eosio_system_tester, * boost::unit_test::tolerance(1e+5) ) try {
   ...
   issue_and_transfer( "bob111111111"_n, core_from_string("1000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111"_n, core_from_string("100.0002"), core_from_string("50.0001") ) );
   BOOST_REQUIRE_EQUAL( success(), vote("bob111111111"_n, vector<account_name>(), "alice1111111"_n ) );
   REQUIRE_MATCHING_OBJECT( proxy( "alice1111111"_n )( "proxied_vote_weight", stake2votes(core_from_string("150.0003")) ), get_voter_info( "alice1111111"_n ) );

   //vote for producers
   BOOST_REQUIRE_EQUAL( success(), vote("alice1111111"_n, { "defproducer1"_n, "defproducer2"_n } ) );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("150.0003")) == get_producer_info( "defproducer1"_n )["total_votes"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("150.0003")) == get_producer_info( "defproducer2"_n )["total_votes"].as_double() );
   ...
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("150.0003")) == get_producer_info( "defproducer3"_n )["total_votes"].as_double() );
   ...
   //REQUIRE_MATCHING_OBJECT( voter( "alice1111111"_n )( "proxied_vote_weight", stake2votes(core_from_string("150.0003")) ), get_voter_info( "alice1111111"_n ) );
   BOOST_REQUIRE_EQUAL( 0, get_producer_info( "defproducer1"_n )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( 0, get_producer_info( "defproducer2"_n )["total_votes"].as_double() );
   ...
   issue_and_transfer( "alice1111111"_n, core_from_string("1000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111"_n, core_from_string("30.0001"), core_from_string("20.0001") ) );
   BOOST_REQUIRE_EQUAL( stake2votes(core_from_string("200.0005")), get_producer_info( "defproducer1"_n )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( 0, get_producer_info( "defproducer2"_n )["total_votes"].as_double() );
   ...
   BOOST_REQUIRE_EQUAL( success(), unstake( "alice1111111"_n, core_from_string("10.0001"), core_from_string("10.0001") ) );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("180.0003")) == get_producer_info( "defproducer1"_n )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( 0, get_producer_info( "defproducer2"_n )["total_votes"].as_double() );
...
BOOST_FIXTURE_TEST_CASE(votepay_transition, eosio_system_tester, * boost::unit_test::tolerance(1e-10)) try {
   ...
   auto* tbl = control->db().find<eosio::chain::table_id_object, eosio::chain::by_code_scope_table>(
                  boost::make_tuple( config::system_account_name,
                                     ...
                                     "producers2"_n ) );
   BOOST_REQUIRE( tbl );
   BOOST_REQUIRE( 0 < microseconds_since_epoch_of_iso_string( get_producer_info2("defproducera"_n)["last_votepay_share_update"] ) );
   ...
   create_account_with_resources( "defproducer1"_n, config::system_account_name, core_from_string("1.0000"), false, net, cpu );
...
BOOST_FIXTURE_TEST_CASE(producer_onblock_check, eosio_system_tester) try {
   ...
   create_account_with_resources( "producvotera"_n, config::system_account_name, core_from_string("1.0000"), false, large_asset, large_asset );
   create_account_with_resources( "producvoterb"_n, config::system_account_name, core_from_string("1.0000"), false, large_asset, large_asset );
   create_account_with_resources( "producvoterc"_n, config::system_account_name, core_from_string("1.0000"), false, large_asset, large_asset );
   ...
   transfer(config::system_account_name, "producvotera"_n, core_from_string("200000000.0000"), config::system_account_name);
   BOOST_REQUIRE_EQUAL(success(), stake("producvotera"_n, core_from_string("70000000.0000"), core_from_string("70000000.0000") ));
   BOOST_REQUIRE_EQUAL(success(), vote( "producvotera"_n, vector<account_name>(producer_names.begin(), producer_names.begin()+10)));
   BOOST_CHECK_EQUAL( wasm_assert_msg( "cannot undelegate bandwidth until the chain is activated (at least 15% of all tokens participate in voting)" ),
                      unstake( "producvotera"_n, core_from_string("50.0000"), core_from_string("50.0000") ) );
   ...
   transfer(config::system_account_name, "producvoterb"_n, core_from_string("100000000.0000"), config::system_account_name);
   BOOST_REQUIRE_EQUAL(success(), stake("producvoterb"_n, core_from_string("4000000.0000"), core_from_string("4000000.0000")));
   transfer(config::system_account_name, "producvoterc"_n, core_from_string("100000000.0000"), config::system_account_name);
   BOOST_REQUIRE_EQUAL(success(), stake("producvoterc"_n, core_from_string("2000000.0000"), core_from_string("2000000.0000")));
   ...
   BOOST_CHECK_EQUAL( success(), unstake( "producvotera"_n, core_from_string("50.0000"), core_from_string("50.0000") ) );
...
BOOST_FIXTURE_TEST_CASE( voters_actions_affect_proxy_and_producers, eosio_system_tester, * boost::unit_test::tolerance(1e+6) ) try {
   ...
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111"_n, core_from_string("30.0001"), core_from_string("20.0001") ) );
   BOOST_REQUIRE_EQUAL( success(), vote( "alice1111111"_n, { "defproducer1"_n, "defproducer2"_n } ) );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("50.0002")) == get_producer_info( "defproducer1"_n )["total_votes"].as_double() );
   ...
   REQUIRE_MATCHING_OBJECT( proxy( "donald111111"_n ), get_voter_info( "donald111111"_n ) );

   //bob111111111 chooses alice1111111 as a proxy
   issue_and_transfer( "bob111111111"_n, core_from_string("1000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111"_n, core_from_string("100.0002"), core_from_string("50.0001") ) );
   BOOST_REQUIRE_EQUAL( success(), vote( "bob111111111"_n, vector<account_name>(), "alice1111111"_n ) );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("150.0003")) == get_voter_info( "alice1111111"_n )["proxied_vote_weight"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("200.0005")) == get_producer_info( "defproducer1"_n )["total_votes"].as_double() );
   ...
   issue_and_transfer( "carol1111111"_n, core_from_string("1000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "carol1111111"_n, core_from_string("30.0001"), core_from_string("20.0001") ) );
   BOOST_REQUIRE_EQUAL( success(), vote( "carol1111111"_n, vector<account_name>(), "alice1111111"_n ) );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("200.0005")) == get_voter_info( "alice1111111"_n )["proxied_vote_weight"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("250.0007")) == get_producer_info( "defproducer1"_n )["total_votes"].as_double() );
   ...
   BOOST_REQUIRE_EQUAL( success(), stake( "carol1111111"_n, core_from_string("50.0000"), core_from_string("70.0000") ) );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("320.0005")) == get_voter_info( "alice1111111"_n )["proxied_vote_weight"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("370.0007")) == get_producer_info( "defproducer1"_n )["total_votes"].as_double() );
   ...
   BOOST_REQUIRE_EQUAL( success(), unstake( "bob111111111"_n, core_from_string("50.0001"), core_from_string("50.0001") ) );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("220.0003")) == get_voter_info( "alice1111111"_n )["proxied_vote_weight"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("270.0005")) == get_producer_info( "defproducer1"_n )["total_votes"].as_double() );
   ...
   BOOST_REQUIRE_EQUAL( success(), vote( "carol1111111"_n, vector<account_name>(), "donald111111"_n ) );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("50.0001")), get_voter_info( "alice1111111"_n )["proxied_vote_weight"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("170.0002")), get_voter_info( "donald111111"_n )["proxied_vote_weight"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("100.0003")), get_producer_info( "defproducer1"_n )["total_votes"].as_double() );
   BOOST_TEST_REQUIRE( stake2votes(core_from_string("100.0003")), get_producer_info( "defproducer2"_n )["total_votes"].as_double() );
   BOOST_REQUIRE_EQUAL( 0, get_producer_info( "defproducer3"_n )["total_votes"].as_double() );
...
BOOST_FIXTURE_TEST_CASE( vote_both_proxy_and_producers, eosio_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( wasm_assert_msg("cannot vote for producers and proxy at same time"),
                        vote( "bob111111111"_n, { "carol1111111"_n }, "alice1111111"_n ) );
...
BOOST_FIXTURE_TEST_CASE( select_invalid_proxy, eosio_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( wasm_assert_msg( "invalid proxy specified" ),
                        vote( "bob111111111"_n, vector<account_name>(), "alice1111111"_n ) );

   //selecting not existing account as a proxy
   BOOST_REQUIRE_EQUAL( wasm_assert_msg( "invalid proxy specified" ),
                        vote( "bob111111111"_n, vector<account_name>(), "notexist"_n ) );
...
BOOST_FIXTURE_TEST_CASE( double_register_unregister_proxy_keeps_votes, eosio_system_tester ) try {
   ...
   issue_and_transfer( "alice1111111"_n, core_from_string("1000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111"_n, core_from_string("5.0000"), core_from_string("5.0000") ) );
   edump((get_voter_info("alice1111111"_n)));
   REQUIRE_MATCHING_OBJECT( proxy( "alice1111111"_n )( "staked", 100000 ), get_voter_info( "alice1111111"_n ) );

   //bob111111111 stakes and selects alice1111111 as a proxy
   issue_and_transfer( "bob111111111"_n, core_from_string("1000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111"_n, core_from_string("100.0002"), core_from_string("50.0001") ) );
   BOOST_REQUIRE_EQUAL( success(), vote( "bob111111111"_n, vector<account_name>(), "alice1111111"_n ) );
   REQUIRE_MATCHING_OBJECT( proxy( "alice1111111"_n )( "proxied_vote_weight", stake2votes( core_from_string("150.0003") ))( "staked", 100000 ), get_voter_info( "alice1111111"_n ) );
   ...
   REQUIRE_MATCHING_OBJECT( voter( "alice1111111"_n )( "proxied_vote_weight", stake2votes(core_from_string("150.0003")) )( "staked", 100000 ), get_voter_info( "alice1111111"_n ) );
...
BOOST_FIXTURE_TEST_CASE( proxy_cannot_use_another_proxy, eosio_system_tester ) try {
   ...
   issue_and_transfer( "carol1111111"_n, core_from_string("1000.0000"),  config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), stake( "carol1111111"_n, core_from_string("100.0002"), core_from_string("50.0001") ) );
   BOOST_REQUIRE_EQUAL( success(), vote( "carol1111111"_n, vector<account_name>(), "alice1111111"_n ) );
   ...
   BOOST_REQUIRE_EQUAL( wasm_assert_msg( "cannot proxy to self" ),
                        vote( "bob111111111"_n, vector<account_name>(), "bob111111111"_n ) );
...
BOOST_FIXTURE_TEST_CASE( elect_producers /*_and_parameters*/, eosio_system_tester ) try {
   ...
   transfer( "eosio"_n, "alice1111111"_n, core_from_string("600000000.0000"), "eosio"_n );
   BOOST_REQUIRE_EQUAL( success(), stake( "alice1111111"_n, "alice1111111"_n, core_from_string("300000000.0000"), core_from_string("300000000.0000") ) );
   //vote for producers
   ...
   // elect 2 producers
   issue_and_transfer( "bob111111111"_n, core_from_string("80000.0000"),  config::system_account_name );
   ilog("stake");
   BOOST_REQUIRE_EQUAL( success(), stake( "bob111111111"_n, core_from_string("40000.0000"), core_from_string("40000.0000") ) );
   ilog("start vote");
   BOOST_REQUIRE_EQUAL( success(), vote( "bob111111111"_n, { "defproducer2"_n } ) );
   ilog(".");
   produce_blocks(250);
...
BOOST_FIXTURE_TEST_CASE( buyname, eosio_system_tester ) try {
   ...
   transfer( config::system_account_name, "dan"_n, core_from_string( "10000.0000" ) );
   transfer( config::system_account_name, "sam"_n, core_from_string( "10000.0000" ) );
   stake_with_transfer( config::system_account_name, "sam"_n, core_from_string( "80000000.0000" ), core_from_string( "80000000.0000" ) );
   stake_with_transfer( config::system_account_name, "dan"_n, core_from_string( "80000000.0000" ), core_from_string( "80000000.0000" ) );
   ...
   bidname( "dan"_n, "nofail"_n, core_from_string( "1.0000" ) );
   BOOST_REQUIRE_EQUAL( "assertion failure with message: must increase bid by 10%", bidname( "sam"_n, "nofail"_n, core_from_string( "1.0000" ) )); // didn't increase bid by 10%
   BOOST_REQUIRE_EQUAL( success(), bidname( "sam"_n, "nofail"_n, core_from_string( "2.0000" ) )); // didn't increase bid by 10%
   produce_block( fc::days(1) );
   produce_block();
   ...
   transfer( "eosio"_n, "nofail"_n, core_from_string( "1000.0000" ) );
...
BOOST_FIXTURE_TEST_CASE( multiple_namebids, eosio_system_tester ) try {
   ...
   stake_with_transfer( config::system_account_name, "bob"_n,  core_from_string( "35000000.0000" ), core_from_string( "35000000.0000" ) );
   stake_with_transfer( config::system_account_name, "carl"_n, core_from_string( "35000000.0000" ), core_from_string( "35000000.0000" ) );
   BOOST_REQUIRE_EQUAL( success(), vote( "bob"_n, { "producer"_n } ) );
   BOOST_REQUIRE_EQUAL( success(), vote( "carl"_n, { "producer"_n } ) );

   // start bids
   bidname( "bob"_n,  "prefa"_n, core_from_string("1.0003") );
   BOOST_REQUIRE_EQUAL( core_from_string( "9998.9997" ), get_balance("bob"_n) );
   bidname( "bob"_n,  "prefb"_n, core_from_string("1.0000") );
   bidname( "bob"_n,  "prefc"_n, core_from_string("1.0000") );
   BOOST_REQUIRE_EQUAL( core_from_string( "9996.9997" ), get_balance("bob"_n) );

   bidname( "carl"_n, "prefd"_n, core_from_string("1.0000") );
   bidname( "carl"_n, "prefe"_n, core_from_string("1.0000") );
   BOOST_REQUIRE_EQUAL( core_from_string( "9998.0000" ), get_balance("carl"_n) );

   BOOST_REQUIRE_EQUAL( error("assertion failure with message: account is already highest bidder"),
                        bidname( "bob"_n, "prefb"_n, core_from_string("1.1001") ) );
   BOOST_REQUIRE_EQUAL( error("assertion failure with message: must increase bid by 10%"),
                        bidname( "alice"_n, "prefb"_n, core_from_string("1.0999") ) );
   BOOST_REQUIRE_EQUAL( core_from_string( "9996.9997" ), get_balance("bob"_n) );
   BOOST_REQUIRE_EQUAL( core_from_string( "10000.0000" ), get_balance("alice"_n) );
   ...
   // alice outbids bob on prefb
   {
      ...
      BOOST_REQUIRE_EQUAL( success(),
                           bidname( "alice"_n, "prefb"_n, core_from_string("1.1001") ) );
      // refund bob's failed bid on prefb
      BOOST_REQUIRE_EQUAL( success(), push_action( "bob"_n, "bidrefund"_n, mvo()("bidder","bob")("newname", "prefb") ) );
      BOOST_REQUIRE_EQUAL( core_from_string( "9997.9997" ), get_balance("bob"_n) );
      BOOST_REQUIRE_EQUAL( core_from_string( "9998.8999" ), get_balance("alice"_n) );
      BOOST_REQUIRE_EQUAL( initial_names_balance + core_from_string("0.1001"), get_balance("eosio.names"_n) );
   }

   // david outbids carl on prefd
   {
      BOOST_REQUIRE_EQUAL( core_from_string( "9998.0000" ), get_balance("carl"_n) );
      BOOST_REQUIRE_EQUAL( core_from_string( "10000.0000" ), get_balance("david"_n) );
      BOOST_REQUIRE_EQUAL( success(),
                           bidname( "david"_n, "prefd"_n, core_from_string("1.9900") ) );
      ...
      BOOST_REQUIRE_EQUAL( core_from_string( "9999.0000" ), get_balance("carl"_n) );
      BOOST_REQUIRE_EQUAL( core_from_string( "9998.0100" ), get_balance("david"_n) );
   }

   // eve outbids carl on prefe
   {
      BOOST_REQUIRE_EQUAL( success(),
                           bidname( "eve"_n, "prefe"_n, core_from_string("1.7200") ) );
   }
   ...
   BOOST_REQUIRE_EQUAL( success(),
                        bidname( "eve"_n,  "prefb"_n, core_from_string("2.1880") ) );
   ...
   BOOST_REQUIRE_EQUAL( success(),
                        bidname( "carl"_n, "prefe"_n, core_from_string("2.0980") ) );
   produce_block( fc::hours(2) );
   produce_blocks(2);
   ...
   transfer( config::system_account_name, "prefe"_n, core_from_string("10000.0000") );
...
BOOST_FIXTURE_TEST_CASE( ram_inflation, eosio_system_tester ) try {
   ...
   produce_blocks(20);
   BOOST_REQUIRE_EQUAL( init_max_ram_size, get_global_state()["max_ram_size"].as_uint64() );
   transfer( config::system_account_name, "alice1111111"_n, core_from_string("1000.0000"), config::system_account_name );
   BOOST_REQUIRE_EQUAL( success(), buyram( "alice1111111"_n, "alice1111111"_n, core_from_string("100.0000") ) );
   produce_blocks(3);
   BOOST_REQUIRE_EQUAL( init_max_ram_size, get_global_state()["max_ram_size"].as_uint64() );
   uint16_t rate = 1000;
   ...
   BOOST_REQUIRE_EQUAL( success(), sellram( "alice1111111"_n, 100 ) );
   BOOST_REQUIRE_EQUAL( cur_ram_size + 6 * rate, get_global_state()["max_ram_size"].as_uint64() );
   cur_ram_size = get_global_state()["max_ram_size"].as_uint64();
   produce_blocks();
   BOOST_REQUIRE_EQUAL( success(), buyrambytes( "alice1111111"_n, "alice1111111"_n, 100 ) );
...
BOOST_FIXTURE_TEST_CASE( eosioram_ramusage, eosio_system_tester ) try {
   ...
   BOOST_REQUIRE_EQUAL( false, get_row_by_account( "eosio.token"_n, "alice1111111"_n, "accounts"_n, account_name(symbol{}.to_symbol_code()) ).empty() );
   ...
   BOOST_REQUIRE_EQUAL( true, get_row_by_account( "eosio.token"_n, "alice1111111"_n, "accounts"_n, account_name(symbol{}.to_symbol_code()) ).empty() );
   ...
   BOOST_REQUIRE_EQUAL( success(), sellram( "alice1111111"_n, 2048 ) );
...
BOOST_FIXTURE_TEST_CASE( ram_gift, eosio_system_tester ) try {
   ...
   */
   ...
   BOOST_REQUIRE_EQUAL( success(), unstake( "eosio"_n, "alice1111111"_n, core_from_string("20.0000"), core_from_string("10.0000") ) );
...
BOOST_FIXTURE_TEST_CASE( change_limited_account_back_to_unlimited, eosio_system_tester ) try {
   BOOST_REQUIRE( get_total_stake( "eosio"_n ).is_null() );

   transfer( "eosio"_n, "alice1111111"_n, core_from_string("1.0000") );

   auto error_msg = stake( "alice1111111"_n, "eosio"_n, core_from_string("0.0000"), core_from_string("1.0000") );
   ...
   stake( "alice1111111"_n, "eosio"_n, core_from_string("0.0000"), core_from_string("1.0000") );

   REQUIRE_MATCHING_OBJECT( get_total_stake( "eosio"_n ), mvo()
      ("owner", "eosio"_n)
