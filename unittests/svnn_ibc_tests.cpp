         ...
         ("proof", mvo() 
            ("finality_proof", mvo() //proves finality of block #2
               ("qc_block", mvo()
                  ...
                  ("witness_hash", block_4_result.lpfp_base_digest)
            ...
            ("target_block_proof_of_inclusion", mvo() 
               ...
               ("target", fc::variants{"extended_block_data", mvo() //target block #2
                  ("finality_data", mvo() 
                     ...
                     ("witness_hash", block_2_result.lpfp_base_digest)
         ...
         ("proof", mvo() 
            ("finality_proof", mvo()  //proves finality of block #3
               ("qc_block", mvo()
                  ...
                  ("witness_hash", block_5_result.lpfp_base_digest)
         ...
         ("proof", mvo() 
            ("finality_proof", mvo() //proves finality of block #7
               ("qc_block", mvo()
                  ...
                  ("witness_hash", block_9_result.lpfp_base_digest)
            ...
            ("target_block_proof_of_inclusion", mvo() 
               ...
               ("target", fc::variants{"extended_block_data", mvo() //target block #2
                  ("finality_data", mvo() 
                     ...
                     ("witness_hash", block_7_result.lpfp_base_digest)
         ...
         ("proof", mvo() 
            ("finality_proof", mvo()
               ("qc_block", mvo()
                  ...
                  ("witness_hash", block_13_result.lpfp_base_digest)
            ...
            ("target_block_proof_of_inclusion", mvo() 
               ...
               ("target",  fc::variants{"extended_block_data", mvo() 
                  ("finality_data", mvo() 
                     ...
                     ("witness_hash", block_12_result.lpfp_base_digest)
