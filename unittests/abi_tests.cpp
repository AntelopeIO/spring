...
{
   auto bytes = abis.variant_to_binary(type, var, yield_fn());
   auto b = abis.variant_to_binary(type, var, max_serialization_time );
   BOOST_TEST( b == bytes );

   auto var2 = abis.binary_to_variant(type, bytes, yield_fn());
...
auto get_resolver(const abi_def& abi = abi_def())
{
   return [&abi](const account_name &name) -> std::optional<abi_serializer> {
      return abi_serializer(eosio_contract_abi(abi), yield_fn());
   };
}
...
{ try {
   ...
   T obj;
   abi_serializer::from_variant(var, obj, get_resolver(), yield_fn());

   T obj2;
   abi_serializer::from_variant(var, obj2, get_resolver(), max_serialization_time);

   fc::variant var2;
   abi_serializer::to_variant(obj, var2, get_resolver(), yield_fn());
...
{ try {
   ...
   abi_serializer abis(eosio_contract_abi(abi), yield_fn());
   ...
   verify_byte_round_trip_conversion(abi_serializer{std::move(abi), yield_fn()}, "test", var);

} FC_LOG_AND_RETHROW() }

BOOST_AUTO_TEST_CASE(std_array_types_short)
{ try {
   ...
   BOOST_CHECK_EXCEPTION( verify_byte_round_trip_conversion(abi_serializer{std::move(abi), yield_fn()}, "test", var),
                          pack_exception, is_assert_exception );
...
{ try {
   ...
   auto var = fc::json::from_string(test_data);
   verify_byte_round_trip_conversion(abi_serializer{std::move(abi), yield_fn()}, "transfer", var);
   ...
   const char *my_other = R"=====(
    {
      ...
      "publickey_arr" :  ["PUB_K1_6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5BoDq63","PUB_K1_6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5BoDq63","PUB_K1_6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5BoDq63"],
      "asset"         : "100.0000 SYS",
      ...
      "keyweight": {"key":"PUB_K1_6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5BoDq63", "weight":"100"},
      "keyweight_arr": [{"key":"PUB_K1_6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5BoDq63", "weight":"100"},{"key":"PUB_K1_6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5BoDq63", "weight":"200"}],
      "authority": {
         "threshold":"10",
         "keys":[{"key":"PUB_K1_6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5BoDq63", "weight":100},{"key":"PUB_K1_6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5BoDq63", "weight":200}],
...
{ try {
   ...
   abi_serializer abis;
   BOOST_CHECK_EXCEPTION( abis.set_abi(std::move(abi), yield_fn()), abi_circular_def_exception, is_assert_exception );
...
{ try {
   ...
   abi_serializer abis(eosio_contract_abi(abi_def()), yield_fn());
...
{ try {
   ...
   const char* test_data = R"=====(
   {
     ...
     "auth" : {
        ...
        "keys" : [ {"key" : "PUB_K1_65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6ZoHPHw", "weight" : 57005},
                   {"key" : "PUB_K1_5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWpj3BS", "weight" : 57605} ],
...
{ try {
   ...
   abi_serializer abis(eosio_contract_abi(v.as<abi_def>()), yield_fn());
...
{ try {
   ...
   fc::variant var;
   abi_serializer::to_variant(packed_txn, var, get_resolver(fc::json::from_string(packed_transaction_abi).as<abi_def>()), yield_fn());
   fc::variant var2;
   ...
   abi_serializer::from_variant(var, packed_txn2, get_resolver(fc::json::from_string(packed_transaction_abi).as<abi_def>()), yield_fn());
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( abi_serializer abis(std::move(abi), yield_fn()), duplicate_abi_type_def_exception, is_table_exception );
} FC_LOG_AND_RETHROW() }
...
{ try {
   ...
   auto abi = eosio_contract_abi(fc::json::from_string(repeat_abi).as<abi_def>());
   BOOST_CHECK_THROW( abi_serializer abis(std::move(abi), yield_fn()), duplicate_abi_struct_def_exception );
} FC_LOG_AND_RETHROW() }
...
{ try {
   ...
   auto abi = eosio_contract_abi(fc::json::from_string(repeat_abi).as<abi_def>());
   BOOST_CHECK_THROW( abi_serializer abis(std::move(abi), yield_fn()), duplicate_abi_action_def_exception );
} FC_LOG_AND_RETHROW() }
...
{ try {
   ...
   auto abi = eosio_contract_abi(fc::json::from_string(repeat_abi).as<abi_def>());
   BOOST_CHECK_THROW( abi_serializer abis(std::move(abi), yield_fn()), duplicate_abi_table_def_exception );
} FC_LOG_AND_RETHROW() }
...
{ try {
   ...
   abi_serializer abis(fc::json::from_string(repeat_abi).as<abi_def>(), yield_fn());
   BOOST_CHECK(abis.is_type("name", yield_fn()));
   BOOST_CHECK(abis.is_type("account_name", yield_fn()));
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( abi_serializer abis(fc::json::from_string(repeat_abi).as<abi_def>(), yield_fn()), duplicate_abi_type_def_exception, is_type_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( abi_serializer abis(fc::json::from_string(repeat_abi).as<abi_def>(), yield_fn()), abi_circular_def_exception, is_type_exception );
...
{ try {
   ...
   BOOST_CHECK_THROW( abi_serializer abis(fc::json::from_string(repeat_abi).as<abi_def>(), yield_fn()), parse_error_exception );
...
{ try {
   ...
   BOOST_CHECK_EXCEPTION( abi_serializer abis(std::move(abi), yield_fn()), duplicate_abi_type_def_exception, is_type_exception );
...
BOOST_AUTO_TEST_CASE(abi_large_array)
{
   try {
      ...
      abi_serializer abis( fc::json::from_string( abi_str ).as<abi_def>(), yield_fn() );
      ...
      BOOST_CHECK_THROW( abis.binary_to_variant( "hi[]", bin, yield_fn() );, fc::exception );
...
BOOST_AUTO_TEST_CASE(abi_is_type_recursion)
{
   try {
      ...
      BOOST_CHECK_THROW( abi_serializer abis(fc::json::from_string(abi_str).as<abi_def>(), yield_fn()), fc::exception );
...
BOOST_AUTO_TEST_CASE(abi_recursive_structs)
{
   try {
      ...
      auto bin = abis.variant_to_binary("hi2", fc::json::from_string(hi_data), yield_fn());
...
{
   try {
      abi_serializer abis( fc::json::from_string( large_nested_abi ).as<abi_def>(), yield_fn() );
      ...
      BOOST_CHECK_THROW( abis.variant_to_binary( "s98", fc::json::from_string( hi_data ), yield_fn() ), fc::exception );
...
BOOST_AUTO_TEST_CASE(abi_deep_structs_validate)
{
   try {
      BOOST_CHECK_THROW(
            abi_serializer abis( fc::json::from_string( deep_nested_abi ).as<abi_def>(), yield_fn() ),
            fc::exception );
   } FC_LOG_AND_RETHROW()
}
...
BOOST_AUTO_TEST_CASE(variants)
{
   ...
   try {
      ...
      BOOST_CHECK_THROW( abi_serializer( fc::json::from_string(duplicate_variant_abi).as<abi_def>(), yield_fn() ), duplicate_abi_variant_def_exception );

      // invalid_type_inside_abi
      BOOST_CHECK_THROW( abi_serializer( fc::json::from_string(variant_abi_invalid_type).as<abi_def>(), yield_fn() ), invalid_type_inside_abi );

      // expected array containing variant
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("v1", fc::json::from_string(R"(9)"), yield_fn()),
                             pack_exception, fc_exception_message_starts_with("Expected input to be an array of two items while processing variant 'v1'") );
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("v1", fc::json::from_string(R"([4])"), yield_fn()),
                             pack_exception, fc_exception_message_starts_with("Expected input to be an array of two items while processing variant 'v1") );
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("v1", fc::json::from_string(R"([4, 5])"), yield_fn()),
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("v1", fc::json::from_string(R"(["4", 5, 6])"), yield_fn()),
                             pack_exception, fc_exception_message_starts_with("Expected input to be an array of two items while processing variant 'v1'") );
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("v1", fc::json::from_string(R"(["int9", 21])"), yield_fn()),
...
BOOST_AUTO_TEST_CASE(extend)
{
   ...
   try {
      abi_serializer abis(fc::json::from_string(abi).as<abi_def>(), yield_fn() );

      // missing i1
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("s", fc::json::from_string(R"({"i0":5})"), yield_fn()),
      ...
      // Unexpected 'a'
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("s", fc::json::from_string(R"({"i0":5,"i1":6,"a":[8,9,10]})"), yield_fn()),
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("s2", fc::json::from_string(R"({"i0":1})"), yield_fn()),
...
{
   try {
      BOOST_CHECK_THROW( abi_serializer(fc::json::from_string(R"({})").as<abi_def>(), yield_fn()), unsupported_abi_version_exception );
      BOOST_CHECK_THROW( abi_serializer(fc::json::from_string(R"({"version": ""})").as<abi_def>(), yield_fn()), unsupported_abi_version_exception );
      BOOST_CHECK_THROW( abi_serializer(fc::json::from_string(R"({"version": "eosio::abi/9.0"})").as<abi_def>(), yield_fn()), unsupported_abi_version_exception );
      abi_serializer(fc::json::from_string(R"({"version": "eosio::abi/1.0"})").as<abi_def>(), yield_fn());
      abi_serializer(fc::json::from_string(R"({"version": "eosio::abi/1.1"})").as<abi_def>(), yield_fn());
   } FC_LOG_AND_RETHROW()
}
...
BOOST_AUTO_TEST_CASE(abi_serialize_incomplete_json_array)
{
   ...
   try {
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("s", fc::json::from_string(R"([])"), yield_fn()),
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("s", fc::json::from_string(R"([1,2])"), yield_fn()),
                             pack_exception, fc_exception_message_starts_with("Early end to input array specifying the fields of struct") );
...
BOOST_AUTO_TEST_CASE(abi_serialize_incomplete_json_object)
{
   ...
   try {
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("s2", fc::json::from_string(R"({})"), yield_fn()),
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("s2", fc::json::from_string(R"({"f0":{"i0":1}})"), yield_fn()),
...
BOOST_AUTO_TEST_CASE(abi_serialize_json_mismatching_type)
{
   ...
   try {
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("s2", fc::json::from_string(R"({"f0":1,"i1":2})"), yield_fn()),
...
BOOST_AUTO_TEST_CASE(abi_serialize_json_empty_name)
{
   ...
   try {
      ...
      auto bin1 = abis.variant_to_binary("s1", fc::json::from_string(R"({"":1})"), yield_fn());
...
BOOST_AUTO_TEST_CASE(abi_serialize_detailed_error_messages)
{
   ...
   try {
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("bar", fc::json::from_string(R"({"f0":{"i0":1},"i2":3})"), yield_fn()),
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("s3", fc::json::from_string(R"({"i0":1,"i2":3})"), yield_fn()),
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("s3", fc::json::from_string(R"({"i0":1,"i1":2,"i2":3,"f3":["s2",{}]})"), yield_fn()),
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("s3", fc::json::from_string(R"({"i0":1,"i1":2,"i2":3,"f3":["bar",{"f0":{"i0":11},"i2":13}]})"), yield_fn()),
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("v1", fc::json::from_string(R"(["s3",{"i0":1,"i1":2,"i2":3,"f3":["bar",{"f0":{"i0":11,"i1":12},"i2":13}],"f5":0}])"), yield_fn()),
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("v1", fc::json::from_string(R"(["s4",{"f0":[0,1],"f1":[{"i0":2,"i1":3},{"i1":5}]}])"), yield_fn()),
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("s2[]", fc::json::from_string(R"([{"f0":{"i0":1,"i1":2},"i2":3},{"f0":{"i0":4},"i2":6}])"), yield_fn()),
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("s5", fc::json::from_string(R"({"f0":[["bar",{"f0":{"i0":1,"i1":2},"i2":3}],["foo",{"f0":{"i0":4},"i2":6}]]})"), yield_fn()),
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("s1arrayarray", fc::json::from_string(R"([[{"i0":1,"i1":2},{"i0":3,"i1":4}],[{"i0":6,"i1":6},{"i0":7,"i1":8},{"i1":10}]])"), yield_fn()),
...
BOOST_AUTO_TEST_CASE(abi_serialize_short_error_messages)
{
   ...
   try {
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("bar", fc::json::from_string(R"({"f0":{"i0":1},"i2":3})"), yield_fn(), true),
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary( "very_very_very_very_very_very_very_very_very_very_long_struct_name_s3",
                                                     fc::json::from_string(R"({"i0":1,"i2":3})"), yield_fn(), true ),
                             pack_exception,
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary( "very_very_very_very_very_very_very_very_very_very_long_struct_name_s3",
                                                     fc::json::from_string(R"({"i0":1,"i1":2,"i2":3,"f3":["s2",{}]})"), yield_fn(), true ),
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary( "very_very_very_very_very_very_very_very_very_very_long_struct_name_s3",
                                                     fc::json::from_string(R"({"i0":1,"i1":2,"i2":3,"f3":["bar",{"f0":{"i0":11},"i2":13}]})"), yield_fn(), true ),
                             pack_exception, fc_exception_message_is("Missing field 'i1' in input object while processing struct 's1'") );
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary( "very_very_very_very_very_very_very_very_very_very_long_struct_name_s3",
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("v1", fc::json::from_string(R"(["s4",{"f0":[0,1],"f1":[{"i0":2,"i1":3},{"i1":5}]}])"), yield_fn(), true),
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("s2[]", fc::json::from_string(R"([{"f0":{"i0":1,"i1":2},"i2":3},{"f0":{"i0":4},"i2":6}])"), yield_fn(), true),
                             pack_exception, fc_exception_message_is("Missing field 'i1' in input object while processing struct 's1'") );
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("s5", fc::json::from_string(R"({"f0":[["bar",{"f0":{"i0":1,"i1":2},"i2":3}],["foo",{"f0":{"i0":4},"i2":6}]]})"), yield_fn(), true),
                             pack_exception, fc_exception_message_is("Missing field 'i1' in input object while processing struct 's1'") );
      ...
      BOOST_CHECK_EXCEPTION( abis.variant_to_binary("s1arrayarray", fc::json::from_string(R"([[{"i0":1,"i1":2},{"i0":3,"i1":4}],[{"i0":6,"i1":6},{"i0":7,"i1":8},{"i1":10}]])"), yield_fn(), true),
                             pack_exception, fc_exception_message_is("Missing field 'i0' in input object while processing struct 's1'") );
...
BOOST_AUTO_TEST_CASE(abi_deserialize_detailed_error_messages)
{
   ...
   abi_serializer abis( fc::json::from_string(abi).as<abi_def>(), yield_fn() );
   BOOST_CHECK_NO_THROW( abis.binary_to_variant("s4", fc::variant("030101000103").as<bytes>(), yield_fn()) );
   BOOST_CHECK_NO_THROW( abis.binary_to_variant("s4", fc::variant("030101000103").as<bytes>(), max_serialization_time) );

   try {

      BOOST_CHECK_EXCEPTION( abis.binary_to_variant("s2", fc::variant("020102").as<bytes>(), yield_fn()),
      ...
      BOOST_CHECK_EXCEPTION( abis.binary_to_variant("s2", fc::variant("0201020103").as<bytes>(), yield_fn()),
      ...
      BOOST_CHECK_EXCEPTION( abis.binary_to_variant("s2", fc::variant("020102ff").as<bytes>(), yield_fn()),
      ...
      BOOST_CHECK_EXCEPTION( abis.binary_to_variant("s3", fc::variant("010203").as<bytes>(), yield_fn()),
      ...
      BOOST_CHECK_EXCEPTION( abis.binary_to_variant("s3", fc::variant("02010304").as<bytes>(), yield_fn()),
                             abi_exception, fc_exception_message_is("Encountered field 'i5' without binary extension designation while processing struct 's3'") );
      BOOST_CHECK_EXCEPTION( abis.binary_to_variant("s3", fc::variant("02010304").as<bytes>(), max_serialization_time),
                             abi_exception, fc_exception_message_is("Encountered field 'i5' without binary extension designation while processing struct 's3'") );

      BOOST_CHECK_EXCEPTION( abis.binary_to_variant("s4", fc::variant("020101").as<bytes>(), yield_fn()),
      ...
      BOOST_CHECK_EXCEPTION( abis.binary_to_variant("s5", fc::variant("02010102").as<bytes>(), yield_fn()),
      ...
      BOOST_CHECK_EXCEPTION( abis.binary_to_variant("s5", fc::variant("0001").as<bytes>(), yield_fn()),
      ...
      BOOST_CHECK_EXCEPTION( abis.binary_to_variant("s5", fc::variant("00010501").as<bytes>(), yield_fn()),
      ...
      BOOST_CHECK_EXCEPTION( abis.binary_to_variant("s5", fc::variant("00010101").as<bytes>(), yield_fn()),
...
BOOST_AUTO_TEST_CASE(abi_to_variant__add_action__good_return_value)
{
...

   {
      ...
      eosio::chain::impl::abi_traverse_context ctx(yield_fn(), fc::microseconds{});
...
inline std::pair<call_trace, std::string> generate_call_trace(bool include_return_value)  {
   ...
   ct.console = "console line in call";
...
// Generate an action trace which embeds a call trace
inline std::pair<action_trace, std::string> generate_action_trace_embedding_call_trace() {
   // Action trace portion
   action_trace at;
   at.action_ordinal = 0;
   at.creator_action_ordinal = 1;
   at.closest_unnotified_ancestor_action_ordinal = 2;
   ...
   at.act = eosio::chain::action(
      ...
      bytes{fc::raw::pack(std::string{"test_data"})});
   at.elapsed = fc::microseconds{3};
   at.console = "console line in action";
   at.trx_id = transaction_id_type{"5d039021cf3262c5036a6ad40a809ae1440ae6c6792a48e6e95abf083b108d5f"};
   at.block_num = 4;
   at.block_time = block_timestamp_type{5};
   at.producer_block_id = std::optional<block_id_type>{};
   at.return_value = fc::raw::pack(50);

   // call trace portion
   bool include_return_value = true;
   auto [ctrace, expected_call_trace_json] = generate_call_trace(include_return_value);
   at.call_traces.emplace_back(
      eosio::chain::call_trace(ctrace.sender_ordinal, ctrace.receiver, ctrace.read_only, ctrace.data));
   at.call_traces[0].call_ordinal = 1;
   at.call_traces[0].elapsed = fc::microseconds{3};
   at.call_traces[0].console = "console line in call";
   at.call_traces[0].console_markers = std::vector<fc::unsigned_int> { 0 };
   at.call_traces[0].return_value = fc::raw::pack(100);
   expected_call_trace_json.replace(0, 14, "\"call_traces\":["); // Replace `{"call_trace":` with `"call_traces":[` at the beginning
   expected_call_trace_json.back() = ']'; // eplace last '}' with ']'
   expected_call_trace_json += ",\"console_markers\":[]";
   ...
   expected_json
      ...
      <<         "\"context_free\":false,"
      <<         "\"elapsed\":3,"
      <<         "\"console\":\"console line in action\","
      <<         "\"trx_id\":\"5d039021cf3262c5036a6ad40a809ae1440ae6c6792a48e6e95abf083b108d5f\","
      <<         "\"block_num\":4,"
      <<         "\"block_time\":\"2000-01-01T00:00:02.500\","
      <<         "\"producer_block_id\":null,"
      ...
      <<         "\"except\":null,"
      <<         "\"error_code\":null,"
      <<         "\"return_value_hex_data\":\"32000000\","  // 50 in little endian
      <<         "\"return_value_data\":50,"
      <<         expected_call_trace_json
      << "}}";

   return std::make_pair(at, expected_json.str());
}

// Verify call traces embedded in an action trace is expanded
BOOST_AUTO_TEST_CASE(action_trace_embedding_call_trace_test) {
   action_trace at;
   std::string expected_json;
   std::tie(at, expected_json) = generate_action_trace_embedding_call_trace();
