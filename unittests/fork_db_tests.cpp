...
// test `fork_database_t::is_child_of() const` member
// -------------------------------------------------------------
BOOST_FIXTURE_TEST_CASE(is_child_of, generate_fork_db_state) try {

   BOOST_REQUIRE_EQUAL(false,  fork_db.is_child_of(bsp14b->id(), bsp14b->id()));
   BOOST_REQUIRE_EQUAL(false,  fork_db.is_child_of(bsp14b->id(), bsp13b->id()));
   BOOST_REQUIRE_EQUAL(false,  fork_db.is_child_of(bsp14b->id(), bsp12b->id()));
   BOOST_REQUIRE_EQUAL(false,  fork_db.is_child_of(bsp14b->id(), bsp11b->id()));

   BOOST_REQUIRE_EQUAL(true,  fork_db.is_child_of(bsp13b->id(), bsp14b->id()));
   BOOST_REQUIRE_EQUAL(true,  fork_db.is_child_of(bsp12b->id(), bsp14b->id()));
   BOOST_REQUIRE_EQUAL(true,  fork_db.is_child_of(bsp11b->id(), bsp14b->id()));
   BOOST_REQUIRE_EQUAL(true,  fork_db.is_child_of(root->id(), bsp11a->id()));
   BOOST_REQUIRE_EQUAL(true,  fork_db.is_child_of(root->id(), bsp12a->id()));
   BOOST_REQUIRE_EQUAL(true,  fork_db.is_child_of(root->id(), bsp14b->id()));

   BOOST_REQUIRE_EQUAL(false,  fork_db.is_child_of(bsp12b->id(), bsp13a->id()));
   BOOST_REQUIRE_EQUAL(false,  fork_db.is_child_of(bsp11b->id(), bsp13a->id()));
