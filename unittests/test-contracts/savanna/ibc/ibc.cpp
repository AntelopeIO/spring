...
void ibc::_check_finality_proof(const finality_proof& finality_proof, const block_proof_of_inclusion& target_block_proof_of_inclusion){
    ...
    _check_qc(quorum_certificate(finality_proof.active_policy_qc), block_finality_data_internal(finality_proof.qc_block).finality_digest(), finalizer_policy);
    ...
    if (finality_proof.qc_block.pending_finalizer_policy_generation.has_value()){
        ...
        _check_qc(quorum_certificate(finality_proof.pending_policy_qc.value()) , block_finality_data_internal(finality_proof.qc_block).finality_digest(), target.finality_data.last_pending_finalizer_policy.value());
