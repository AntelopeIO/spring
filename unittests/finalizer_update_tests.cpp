...
BOOST_AUTO_TEST_CASE(savanna_set_finalizer_multiple_test) { try {
   ...
   b0 = t.produce_block().block;
   auto pubkeys4 = fin_keys.set_finalizer_policy(4);
   auto b1 = t.produce_block().block;
   auto b2 = t.produce_block().block;
