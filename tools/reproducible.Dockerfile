...
COPY <<-"EOF" /pinnedtoolchain/pinnedtoolchain.cmake
   ...
   set(CMAKE_C_FLAGS_INIT "-D_FORTIFY_SOURCE=3 -fstack-protector-strong -fpie -pthread")
   set(CMAKE_CXX_FLAGS_INIT "-nostdinc++ -D_FORTIFY_SOURCE=3 -fstack-protector-strong -fpie -pthread")
