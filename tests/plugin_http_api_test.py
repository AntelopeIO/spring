...
class PluginHttpTest(unittest.TestCase):
    ...
    EOSIO_ACCT_PUBLIC_DEFAULT_KEY = "PUB_K1_6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5BoDq63"

    def endpoint(self, category: str):
        return f'http://{self.nodeos.host}:{category_config.port(category)}'
   ...
   # kill nodeos. keosd shuts down automatically
    ...
    def test_ChainApi(self) :
        ...
        payload = {"ref_block_num":"100",
                   ...
                   "signatures": [],
                   "authorizations": [],
                   "available_keys":["PUB_K1_4toFS3YXEQCkuuw1aqDLrtHim86Gz9u3hBdcBw5KNPZcvAqHHR",
                   "PUB_K1_7d9A3uLe6As66jzN8j44TXJUqJSK3bFjjEEqR4oTvNAAysFemF",
    ...
    def test_WalletApi(self) :
        ...
        payload = [signed_transaction,
                   ["PUB_K1_696giL6VxeJhtEgKtWPK8aQeT8YXNjw2a7vE5wHunffhgMdusd"],
